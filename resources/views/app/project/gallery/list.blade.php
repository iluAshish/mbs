    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="nav-icon fas fa-user-shield"></i> Manage Project Gallery</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{url(Helper::sitePrefix().'dashboard')}}">Home</a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{url(Helper::sitePrefix().'project')}}">Projects</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="gloss_card-header">
                            <a href="{{url(Helper::sitePrefix().'project/gallery/create/'.$project_id)}}"
                               class="btn btn-success pull-right">Add Project Gallery <i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="gallery_order"
                                                       ...
                                                       data-table="ProjectGallery" data-id="{{ $gallery->id }}"
                                            ...
                                            <td>
                                                <label class="switch">
                                                    <input type="checkbox" class="status_check"
                                                           data-url="/status-change" data-table="ProjectGallery"
                                            ...
                                            <td class="text-right py-0 align-middle">
                                                <div class="btn-group btn-group-sm">
                                                    <a href="{{url(Helper::sitePrefix().'project/gallery/edit/'.$gallery->id)}}"
                                                       class="btn btn-success mr-2 tooltips" title="Edit Gallery"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a href="#" class="btn btn-danger mr-2 delete_entry tooltips"
                                                       title="Delete Gallery" data-url="project/gallery/delete"
