    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="nav-icon fas fa-user-shield"></i> Manage Product Brand Gallery</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Brand Gallery</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="gloss_card-header">
                            <a href="{{url(Helper::sitePrefix().'products/brand/gallery/create/'.$brand->id)}}"
                        ...
                        <div class="gloss_card">
                            <div class="gloss_card-body">
                                <table class="table table-bordered table-hover dataTable">
                                    ...
                                    <tbody>
                                    @foreach($brandGalleries as $gallery)
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="gallery_order"
                                                       ...
                                                       data-table="ProductBrandGallery" data-id="{{ $gallery->id }}"
                                                       data-field="brand_id"
                                            ...
                                            <td>
                                                <label class="switch">
                                                    <input type="checkbox" class="status_check"
                                                           data-url="/status-change" data-table="ProductBrandGallery"
                                            ...
                                            <td class="text-right py-0 align-middle">
                                                <div class="btn-group btn-group-sm">
                                                    <a href="{{url(Helper::sitePrefix().'products/brand/gallery/edit/'.$gallery->id)}}"
                                                       class="btn btn-success mr-2 tooltips" title="Edit Gallery"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a href="#" class="btn btn-danger mr-2 delete_entry tooltips"
                                                       title="Delete Gallery" data-url="products/brand/gallery/delete"
