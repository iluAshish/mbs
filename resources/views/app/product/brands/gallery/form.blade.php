                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{url(Helper::sitePrefix().'products/brand/gallery/'.$brand_id)}}">Gallery</a></li>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#image").fileinput({
                ...
                maxFilesize: 10240,
                showRemove: true,
                @if(isset($brand_gallery) && $brand_gallery->image!=NULL)
                initialPreview: ["{{asset($brand_gallery->image)}}",],
                initialPreviewConfig: [{
                    caption: "{{ ($brand_gallery->image!=NULL)?last(explode('/',$brand_gallery->image)):''}}",
                    width: "120px"
                }]
                @endif
            });
