    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="nav-icon fas fa-user-shield"></i> Manage Media Gallery - {{ $mediaData->title }}</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-success card-outline">
                            <div class="card-header">
                                <a href="{{url(Helper::sitePrefix().'media/gallery/create/'.$mediaData->id)}}"
                                   class="btn btn-success pull-right">Add media Gallery <i
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-hover dataTable">
                                    ...
                                    <tbody>
                                    @foreach($mediaGalleryList as $gallery)
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="gallery_order"
                                                       ...
                                                       data-table="MediaGallery" data-id="{{ $gallery->id }}"
                                            ...
                                            {{-- <td>
                                                <label class="switch">
                                                    <input id="switch-state" type="checkbox" class="status_check"
                                                           ...
                                                           data-table="MediaGallery" data-limit = "7"
                                            ...
                                            <td class="text-right py-0 align-middle">
                                                <div class="btn-group btn-group-sm">
                                                    <a href="{{url(Helper::sitePrefix().'media/gallery/edit/'.$gallery->id)}}"
                                                    ...
                                                    <a href="javascript:void(0)" class="btn btn-danger mr-2 delete_entry tooltips"
                                                       title="Delete Gallery" data-url="media/gallery/delete"
