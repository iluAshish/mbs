...
@if(isset($product_page))
    @php 
        ...
        $col = 'col--6';
        $displayName = $product_page->title ?? '';
    @endphp
@elseif(isset($service_page))
    @php 
        $prefix = 'service-detail'; 
        $title = 'Service Enquiry';
        $col = 'col--6';
        $displayName = $service_page->title ?? '';
    @endphp
@elseif(isset($brand_page))
    @php 
        $prefix = 'brand-detail'; 
        $title = 'Brand Enquiry';
        $col = 'col--6';
        $displayName = $brand_page->title ?? '';
    @endphp
@endif
