@if($blogs->isNotEmpty())
    @foreach($blogs as $blog)
        <div class="recent-blog-card">
            <picture>
                <img src="{{asset($blog->image_webp ?? $blog->image)}}" width="381" height="220" {{$blog->image_attribute}}>
            </picture>
                    <div class="recent-blog-details">
                <div>
                        <div class="author d-flex flex-wrap">
                    <div class="profile d-flex align-items-center flex-wrap">
                        <img src="{{asset($blog->admin_webp_image ?? $blog->admin_image ?? 'web/images/blog/author.png')}}" width="35" height="35" {{$blog->admin_image_attribute}}>
                    ...
                    <a href="{{route('blogs.blog_detail',['short_url' => $blog->short_url])}}" class="btn-theme btnDark">Read More</a>
                        <div class="views">
