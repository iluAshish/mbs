...
<head>
    <meta charset="UTF-8">
    <meta name="theme-color" content="#e2251d ">
    <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <meta name=keywords content="">

    <title>We are master distributors for consumables and general Lab equipment all across the MENA Region. We are based in Dubai, United Arab Emirates.</title>
    <meta name=description content="">

    <meta property="og:title" content="MEDICOM">
    <meta property="og:description" content="">
    <meta property="og:image" content="" />

    <link rel="icon" type="image/x-icon" href="https://pentacodesdemo.com/medicom/assets/images/svg/favicon.svg">
    ...
    <link rel="stylesheet" href="https://pentacodesdemo.com/medicom/assets/css/style.min.css">
    <link rel="stylesheet" href="https://pentacodesdemo.com/medicom/assets/css/custom_animation.min.css">
</head>
<body id="home">
            ...
            <div class="col-4 col-md-8 d-flex align-items-center ">
                <div class="info">
                    <a href="tel:+97167454194">
                        ...
                        <span>(+971) 67454194</span>
                    </a>
                    <a href="mailto:info@medicom-grp.com">
                        ...
                        <span>info@medicom-grp.com</span>
                    </a>
                </div>
            </div>
                    ...
                    <a href="" target="_blank">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_194_146)">
                                <path d="M19.9953 19.9999L20.0003 19.999V12.664C20.0003 9.07569 19.2278 6.31152 15.0328 6.31152C13.0161 6.31152 11.6628 7.41819 11.1103 8.46736H11.052V6.64652H7.07446V19.999H11.2161V13.3874C11.2161 11.6465 11.5461 9.96319 13.702 9.96319C15.8261 9.96319 15.8578 11.9499 15.8578 13.499V19.9999H19.9953Z" fill="white"/>
                                <path d="M0.3302 6.64746H4.47687V20H0.3302V6.64746Z" fill="white"/>
                                <path d="M2.40191 0C1.07608 0 0.000244141 1.07583 0.000244141 2.40167C0.000244141 3.7275 1.07608 4.82583 2.40191 4.82583C3.72774 4.82583 4.80358 3.7275 4.80358 2.40167C4.80274 1.07583 3.72691 0 2.40191 0Z" fill="white"/>
                            </g>
                            <defs>
                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item dropdown has-megamenu" id="myDropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu2">
                                    <div class="leftList">
                                        ...
                                        <li>
                                            <a id="productsMenu01" class="dropdown-item" href="products.php">
                                                Food & Beverages
                                            </a>
                                        </li>
                                        <li>
                                            <a id="productsMenu01" class="dropdown-item" href="products.php">
                                                Metal & Flexible Packaging Solutions
                                            </a>
                                        </li>
                                        <li>
                                            <a id="productsMenu01" class="dropdown-item" href="products.php">
                                    ...
                                    <div class="rightBrands">
                                        ...
                                        <div class="logoWrapper">
                                            <a href="">
                                                <img src="assets/images/brands/brands-01.png" class="img-fluid" alt="">
                                            </a>
                                            <a href="">
                                                <img src="assets/images/brands/brands-02.png" class="img-fluid" alt="">
                                            </a>
                                            <a href="">
                                                <img src="assets/images/brands/brands-03.png" class="img-fluid" alt="">
                                            </a>
                                            <a href="">
                                                <img src="assets/images/brands/brands-04.png" class="img-fluid" alt="">
                                            </a>
                                            <a href="">
                                                <img src="assets/images/brands/brands-05.png" class="img-fluid" alt="">
                                            </a>
                                            <a href="">
                                                <img src="assets/images/brands/brands-06.png" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </ul>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" id="scientificMenu" href="medicom-scientific.php"> Medicom Scientific </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" id="newsMenu" href="news-events.php"> News & Events </a>
                            </li>
                            <li class="nav-item ">
...
<div class="offcanvas offcanvas-end mobileMenu" tabindex="-1" id="mobileMenu" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body">
        <ul>
            ...
            <li>
                <a id="homeMobileMenu" href="index.php">
                    <h6>Home</h6>
                </a>
            </li>
            <li>
                <a id="aboutMobileMenu" href="about-us.php">
                    <h6>About Us</h6>
                </a>
            </li>
            <li>
                <a id="industriesMobileMenu" data-bs-toggle="offcanvas" data-bs-target="#mobileProductMenu" aria-controls="offcanvasRight" href="products.php">
            ...
            <li>
                <a id="scientificMobileMenu" href="medicom-scientific.php">
                    <h6>Medicom Scientific</h6>
                </a>
            </li>
            <li>
                <a id="newsMobileMenu" href="news-events.php">
                    <h6>News & Events</h6>
                </a>
            </li>
            <li>
                <a id="blogMobileMenu" href="blog.php">
                    <h6>Blogs</h6>
                </a>
            </li>
            <li>
...
<div class="offcanvas offcanvas-end mobileMenu" tabindex="-1" id="mobileProductMenu" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body">
        ...
        <ul class="mt-30">
            <li>
                <a href="products.php"><h6>Food & Beverages</h6></a>
            </li>
            <li>
                <a href="products.php"><h6>Metal & Flexible Packaging Solutions</h6></a>
            </li>
            <li>
                <a href="products.php"><h6>Pharmaceutical Solutions</h6></a>
            </li>
            <li>
                <a href="products.php"><h6>Medicom Scientific</h6></a>
            </li>
        </ul>
    </div>
</div>
...
<section class="banner">
    <div class="homeBannerSlider">
        <div class="slider">
            <img src="assets/images/slider/slider-01.jpg" class="img-fluid w-100 sliderBgImage" alt="">
            <div class="overlayBg">
                <img src="assets/images/slider/sliderLogo.svg" class="img-fluid" alt="">
            </div>
                    ...
                    <div class="row h-auto">
                        <div class="col-md-7 contentArea">
                            <div class="w-100 h-auto">
                                <h1>Advanced Visual Inspection for Food, Beverage, & Packaging Industries</h1>
                                <p>We are master distributors for consumables and general Lab equipment all across the MENA Region. We are based in Dubai, United Arab Emirates.</p>
                                <a href="contact-us.php" class="primary_btn aos-init aos-animate"><span>Contact Us</span></a>
                            </div>
                        </div>
                        <div class="col-md-5 ps-lg-5 d-flex align-items-center justify-content-center mt-md-0 mt-5">
                            <img class="img-fluid sliderSingleImg" src="assets/images/slider/slider-01-01.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="slider">
            <img src="assets/images/slider/slider-02.jpg" class="img-fluid w-100 sliderBgImage" alt="">
            <div class="overlayBg">
                <img src="assets/images/slider/sliderLogo.svg" class="img-fluid" alt="">
            </div>
            <div class="contentWrapper">
                <div class="container h-auto">
                    <div class="row h-auto">
                        <div class="col-md-7 contentArea">
                            <div class="w-100 h-auto">
                                <h1>Advanced Visual Inspection for Food</h1>
                                <p>We are master distributors for consumables and general Lab equipment all across the MENA Region. We are based in Dubai, United Arab Emirates.</p>
                                <a href="contact-us.php" class="primary_btn aos-init aos-animate"><span>Contact Us</span></a>
                            </div>
                        </div>
...
<section class="aboutUsHome">
    <div class="shape">
        <img src="assets/images/aboutShape-01.svg" class="img-fluid" alt="">
    </div>
    ...
    <div class="container position-relative">
        <div class="row ">
            <div class="col-lg-7 pe-lg-4">
                ...
                <h2 data-aos="fade-up" data-aos-duration="1000" class="fw-bold">History Of Success</h2>
                <div class="textWrapper mt-30" data-aos="fade-up" data-aos-duration="2000">
                    <p><b>We are master distributors for consumables <a href="">and general Lab equipment</a> all across the MENA Region. We are based in Dubai, United Arab Emirates.</b></p>
                    <p>The company was founded in 2008 with a very ambitious project for a multinational energy corporation called ConocoPhillips. For which,Medicom receive a recognition letter; the company continues to grow year after year; doubled the sales figures & increased the customer's key accounts base that cover all Middle East & Africa.</p>
                </div>
                <a href="about-us.php" data-aos="fade-up" data-aos-duration="3000" class="primary_btn secondary_btn mt-40"><span>Read More</span></a>
            </div>
            ...
            <div class="col-12">
                <div class="highlightWrapper">
                    <div class="item" data-aos="fade-up"  >
                        <img src="assets/images/highlight/highlight_icon_01.svg" class="img-fluid" alt="">
                        <h6>100% Satisfaction</h6>
                    </div>
                    <div class="item" data-aos="fade-up" data-aos-duration="1000" >
                        <img src="assets/images/highlight/highlight_icon_02.svg" class="img-fluid" alt="">
                        <h6>Well Trained Staff</h6>
                    </div>
                    <div class="item" data-aos="fade-up" data-aos-duration="2000" >
                        <img src="assets/images/highlight/highlight_icon_03.svg" class="img-fluid" alt="">
                        <h6>World Famous Brands</h6>
                    </div>
                    <div class="item" data-aos="fade-up" data-aos-duration="3000" >
                        <img src="assets/images/highlight/highlight_icon_04.svg" class="img-fluid" alt="">
                        <h6>550+ Products</h6>
                    </div>
                </div>
            </div>
...
<section class="weDo" >
    <div class="container position-relative">
        <div class="row" >
            <div class="col-sm-8" data-aos="fade-up" data-aos-duration="2000">
                ...
                <h2 class="fw-bold">Medicom Group</h2>
            </div>
            ...
            <div class="col-12 mt-30" data-aos="fade-up" data-aos-duration="2000">
                <div class="weDoSlider">
                    <div class="weDoCard">
                        <img src="assets/images/weDo/weDo_icon_01.svg" class="img-fluid cardImg" alt="">
                    ...
                    <div class="weDoCard">
                        <img src="assets/images/weDo/weDo_icon_02.svg" class="img-fluid cardImg" alt="">
                        <h6>Metal & Flexible Packaging Solutions</h6>
                        <div class="h-auto mt-auto">
                            <p>Lorem ipsum dolor sit amet, elit consectetur  adipiscing.</p>
                            <a href="" class="moreBtn">
                                Explore More
                    ...
                    <div class="weDoCard">
                        <img src="assets/images/weDo/weDo_icon_03.svg" class="img-fluid cardImg" alt="">
                        <h6>Pharmaceutical Solutions</h6>
                        <div class="h-auto mt-auto">
                            <p>Lorem ipsum dolor sit amet, elit consectetur  adipiscing.</p>
                            <a href="" class="moreBtn">
                                Explore More
                    ...
                    <div class="weDoCard">
                        <img src="assets/images/weDo/weDo_icon_04.svg" class="img-fluid cardImg" alt="">
                        <h6>Medicom Scientific</h6>
                        <div class="h-auto mt-auto">
                            <p>Lorem ipsum dolor sit amet, elit consectetur  adipiscing.</p>
                            <a href="" class="moreBtn">
    ...
    <div class="mapSection" data-aos="fade-up" data-aos-duration="2000">
        <img src="assets/images/mapImage.jpg" class="img-fluid w-100 d-md-block d-none" alt="">
        <img src="assets/images/mapImage02.jpg" class="img-fluid w-100 d-md-none d-block" alt="">
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 d-flex align-items-center mt-lg-0 mt-3">
                <div class="textWrapper">
                    <p>We Offer The Most Advanced, High-Quality Equipment. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                </div>
            </div>
        </div>
        <div class="row mt-20">
            <div class="col-6 col-lg-4 col-xl-3 mt-30 colIndustries">
                <a href="products-details.php" class="industriesCard">
                    <div class="imgBox">
                        <img src="assets/images/products/products-01.png" class="img-fluid" alt="">
                    </div>
                    <div class="detailsBox">
                        <p>OmniTest 5 kN</p>
                        <h6>single column Force Tester</h6>
                        <div class="moreBtn mt-auto">
                            Explore More
                            <img src="assets/images/svg/moreIcon.svg" class="img-fluid" alt="">
                        </div>
                    </div>
            ...
            <div class="col-6 col-lg-4 col-xl-3 mt-30 colIndustries">
                <a href="products-details.php" class="industriesCard">
                    <div class="imgBox">
                        <img src="assets/images/products/products-02.png" class="img-fluid" alt="">
                    </div>
                    <div class="detailsBox">
                        <p>MultiTest-i</p>
                        <h6>Twin column Force Tester</h6>
                        <div class="moreBtn mt-auto">
                            Explore More
                            <img src="assets/images/svg/moreIcon.svg" class="img-fluid" alt="">
                        </div>
            ...
            <div class="col-6 col-lg-4 col-xl-3 mt-30 colIndustries">
                <a href="products-details.php" class="industriesCard">
                    <div class="imgBox">
                        <img src="assets/images/products/products-03.png" class="img-fluid" alt="">
                    </div>
                    <div class="detailsBox">
                        <p>FT51</p>
                        <h6>Continuous In-line Deaerator</h6>
                        <div class="moreBtn mt-auto">
                            Explore More
                            <img src="assets/images/svg/moreIcon.svg" class="img-fluid" alt="">
                        </div>
            ...
            <div class="col-6 col-lg-4 col-xl-3 mt-30 colIndustries">
                <a href="products-details.php" class="industriesCard">
                    <div class="imgBox">
                        <img src="assets/images/products/products-04.png" class="img-fluid" alt="">
                    </div>
                    <div class="detailsBox">
                        <p>Z301</p>
                        <h6>Semi-Automatic Trimmed Can Inspection Gauge </h6>
                        <div class="moreBtn mt-auto">
                            Explore More
                            <img src="assets/images/svg/moreIcon.svg" class="img-fluid" alt="">
                        </div>
            ...
            <div class="col-6 col-lg-4 col-xl-3 mt-30 colIndustries">
                <a href="products-details.php" class="industriesCard">
                    <div class="imgBox">
                        <img src="assets/images/products/products-05.png" class="img-fluid" alt="">
                    </div>
                    <div class="detailsBox">
                        <p>Z307</p>
                        <h6>Semi-Automatic Bench Top Axial Load Gauge</h6>
                        <div class="moreBtn mt-auto">
                            Explore More
                            <img src="assets/images/svg/moreIcon.svg" class="img-fluid" alt="">
                        </div>
            ...
            <div class="col-6 col-lg-4 col-xl-3 mt-30 colIndustries">
                <a href="products-details.php" class="industriesCard">
                    <div class="imgBox">
                        <img src="assets/images/products/products-06.png" class="img-fluid" alt="">
                    </div>
                    <div class="detailsBox">
                        <p>CMC-KUHNKE</p>
                        <h6>SEAMscan XTS III</h6>
                        <div class="moreBtn mt-auto">
                            Explore More
                            <img src="assets/images/svg/moreIcon.svg" class="img-fluid" alt="">
                        </div>
            ...
            <div class="col-6 col-lg-4 col-xl-3 mt-30 colIndustries">
                <a href="products-details.php" class="industriesCard">
                    <div class="imgBox">
                        <img src="assets/images/products/products-07.png" class="img-fluid" alt="">
                    </div>
                    <div class="detailsBox">
                        <p>AUTO-XTS</p>
                        <h6>CMC-KUHNKE AUTO-XTS</h6>
                        <div class="moreBtn mt-auto">
                            Explore More
                            <img src="assets/images/svg/moreIcon.svg" class="img-fluid" alt="">
                        </div>
            ...
            <div class="col-12 d-flex align-items-center justify-content-center mt-50">
                <a href="products.php" class="primary_btn secondary_btn"><span>View All Products</span></a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="testimonialSlider">
                    <div class="testimonialCard">
                        <div class="testimonialImage">
                            <img src="assets/images/testimonial/testimonial-01.jpg" class="img-fluid w-100" alt="">
                        </div>
                        <h5>Daisy Welch</h5>
                        <div class="position">Manager</div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut nec hendrerit tortor, quis finibus diam. Sed pharetra, pulvinar Sed pharetra, ex in pulvinar.</p>
                    </div>
                    <div class="testimonialCard">
                        <div class="testimonialImage">
                            <img src="assets/images/testimonial/testimonial-02.jpg" class="img-fluid w-100" alt="">
                        </div>
                        <h5>Daisy Welch</h5>
                        <div class="position">Manager</div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut nec hendrerit tortor, quis finibus diam. Sed pharetra, pulvinar Sed pharetra, ex in pulvinar. Ut nec hendrerit tortor, quis finibus diam. Sed pharetra, pulvinar Sed pharetra, ex in pulvinar.</p>
                    </div>
                    <div class="testimonialCard">
                        <div class="testimonialImage">
                            <img src="assets/images/testimonial/testimonial-03.jpg" class="img-fluid w-100" alt="">
                        </div>
                        <h5>Daisy Welch</h5>
                        <div class="position">Manager</div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut nec hendrerit tortor, quis finibus diam. Sed pharetra, pulvinar Sed pharetra, ex in pulvinar.</p>
            ...
            <div class="col-lg-8 d-flex align-items-center mt-lg-0 mt-4">
                <div class="w-100">
                    <div class="clientSlider">
                        ...
                        <div class="clientCard">
                            <img src="assets/images/clients/clients-04.png" class="img-fluid" alt="">
                        </div>
                        <div class="clientCard">
                            <img src="assets/images/clients/clients-02.png" class="img-fluid" alt="">
                        </div>
...
<section class="latestNewsSection" data-aos="fade-up" data-aos-duration="2000">
    <div class="shape">
        <img src="assets/images/newsShape-01.svg" class="img-fluid" alt="">
    </div>
    <div class="container position-relative">
        <div class="row">
            <div class="col-8">
                ...
                <div class="latestNewsSlider">
                    <div class="latestNewsCard">
                        ...
                        <div class="blogDetails">
                            ...
                            <a href="news-events-details.php" class="moreBtn mt-auto">
                                Read More
                                <img src="assets/images/svg/moreIcon.svg" class="img-fluid" alt="">
                            </a>
                        </div>
                    ...
                    <div class="latestNewsCard">
                        <div class="imgBox">
                            <img src="assets/images/news/news-02.jpg" class="img-fluid w-100" alt="">
                        </div>
                        <div class="blogDetails">
                            <h6>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut nec hendrerit tortor, quis finibus diam.</h6>
                            <a href="news-events-details.php" class="moreBtn mt-auto">
                                Read More
                                <img src="assets/images/svg/moreIcon.svg" class="img-fluid" alt="">
                            </a>
            ...
            <div class="col-12 d-flex align-items-center justify-content-center mt-40">
                <a href="blog.php" class="primary_btn secondary_btn"><span>View All Blogs</span></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-12 col-xl-4 infoDiv">
                <a href="index.php">
                    <img src="assets/images/footerLogo.svg" class="img-fluid" alt="">
                </a>
                <p class="color_white">We are master distributors for consumables and general Lab equipment all across the MENA Region.</p>
                <div class="social">
                    <a href="" target="_blank">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.9996 0.00416134L12.406 0C9.49227 0 7.60926 1.9319 7.60926 4.92203V7.19141H5.00156C4.77622 7.19141 4.59375 7.37409 4.59375 7.59943V10.8875C4.59375 11.1128 4.77643 11.2953 5.00156 11.2953H7.60926V19.5922C7.60926 19.8175 7.79174 20 8.01707 20H11.4194C11.6447 20 11.8272 19.8173 11.8272 19.5922V11.2953H14.8762C15.1015 11.2953 15.284 11.1128 15.284 10.8875L15.2853 7.59943C15.2853 7.49123 15.2422 7.38762 15.1658 7.31105C15.0895 7.23448 14.9854 7.19141 14.8772 7.19141H11.8272V5.26763C11.8272 4.34298 12.0475 3.87358 13.252 3.87358L14.9992 3.87295C15.2243 3.87295 15.4068 3.69027 15.4068 3.46514V0.411972C15.4068 0.187052 15.2245 0.00457747 14.9996 0.00416134Z" fill="white"/>
            ...
            <div class="col-sm-6 col-lg-5 col-xl-3 info mt-xl-0 mt-lg-5 mt-sm-0 mt-5">
                <h5>Get In Touch</h5>
                <img src="assets/images/footerIcon.svg" alt="">
                <ul>
                    <li>
                        <img src="assets/images/svg/footerLocation.svg" class="img-fluid" alt="">
                        <div>
                            <p>
                    ...
                    <li>
                        <img src="assets/images/svg/footerCall.svg" class="img-fluid" alt="">
                        <div>
                            <p>
                                <a href="">(+971) 67454194</a>
                            </p>
                        </div>
                    </li>
                    <li>
                        <img src="assets/images/svg/footerMail.svg" class="img-fluid" alt="">
                        <div>
                            <p>
                                <a href="">info@medicom-grp.com</a>
                            </p>
                        </div>
                    </li>
                </ul>
            ...
            <div class="col-5 col-sm-6 col-lg-3 col-xl-2 links mt-xl-0 mt-5">
                ...
                <img src="assets/images/footerIcon.svg" alt="">
                <ul>
                    <li><a id="homeFooterMenu" href="index.php">Home</a></li>
                    <li><a id="aboutFooterMenu" href="about-us.php">About Us</a></li>
                    <li><a id="industriesFooterMenu" href="products.php">Industries</a></li>
                    <li><a id="newsFooterMenu" href="news-events.php">News & Events</a></li>
                    <li><a id="blogFooterMenu" href="blog.php">Blogs</a></li>
                    <li><a id="contactFooterMenu" href="contact-us.php">Contact Us</a></li>
                </ul>
            </div>
            <div class="col-7 col-sm-6 col-lg-4 col-xl-3 links mt-xl-0 mt-5">
                ...
                <img src="assets/images/footerIcon.svg" alt="">
                <ul>
                    <li><a href="medicom-scientific.php#universities">Universities and colleges</a></li>
                    <li><a href="medicom-scientific.php#oil">Oil and gas</a></li>
                    <li><a href="medicom-scientific.php#private">Private and public sector</a></li>
                    <li><a href="medicom-scientific.php#research">Research and immolations</a></li>
                    <li><a href="medicom-scientific.php#annual">Annual maintenance contract</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <p>Copyright © <script type="text/javascript">
                    ...
                    </script> Medicom Group LLC. All Rights Reserved Powered by <a href="">Pentacodes LLP</a></p>
            </div>
            <div class="col-lg-4 privacyTerms">
                <a id="privacyMenu" href="privacy-policy.php">Privacy Policy</a>
                <a id="termsConditionsMenu" href="terms-conditions.php">Terms & Conditions</a>
            </div>
        </div>
    </div>
</div>
...
<!-- Modal -->
<div class="modal fade enquiryModal" id="enquiryModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h4>single column Force Tester</h4>
                <form action="">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="">Name <sapn>*</sapn></label>
                                <input type="text" class="form-control" placeholder="Enter Name">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="">Email <sapn>*</sapn></label>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Product" value="MultiTest-i" disabled>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="">Message <sapn>*</sapn></label>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group ">
                                ...
                                <a href="thank-you.php" class="primary_btn"><span>Send Request</span></a>
                            </div>
                        </div>
                    </div>
                </form>
...
<a href="" class="whatsappFixed">
    <img src="assets/images/svg/whatsapp.svg" class="img-fluid" alt="">
</a>

<a href="" download class="brochureFixed">
    <img src="assets/images/svg/download.svg" class="img-fluid" alt="">
</a>
