...
@php
    ...
    $product_page = isset($product) ? $product : null;
            ...
            <div class="content list d-flex flex-wrap">
                <div>
                    ...
                    <div class="meta d-flex align-items-center">
                        <span>
                            <a href="{{route('category.category_detail', ['short_url' => $product->category->short_url]) }}" style="text-decoration: none; color: inherit;">
                        ...
                        <span>
                            <a href="{{route('brands.brand_detail', ['short_url' => $product->brand->short_url]) }}" style="text-decoration: none; color: inherit;">
