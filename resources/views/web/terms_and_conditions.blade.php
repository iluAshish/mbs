...
<section class="terms-header bg-white why-choose inner-padding position-relative">
    <div class="container-short">
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                    <div class=" title">
                        <h1 class="h2"><span>Terms &amp;</span> Conditions</h1>
...
<section class="terms-content list">
    <div class="container-short">
