...
@section('content')
    ...
    <picture>
        <img src="{{asset('web/images/inner/bg.webp')}}" alt="MBS">
    </picture>
    ...
    <section class="sectors bg-white why-choose inner-padding position-relative">
        <div class="container-short">
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                <div class="col-left title">
                    <h2><span>Our</span>Sectors</h2>
                </div>
                <div class="col-right">
            ...
            <div class="d-flex flex-wrap sectors-row">
